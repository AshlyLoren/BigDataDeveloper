...
//
// Debug information:
// Generated date: Wed Mar 27 12:51:02 UTC 2024
...
public class products extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.product_category_id = JdbcWritableBridge.readInteger(1, __dbResults);
    this.product_description = JdbcWritableBridge.readString(2, __dbResults);
    this.product_id = JdbcWritableBridge.readInteger(3, __dbResults);
    this.product_image = JdbcWritableBridge.readString(4, __dbResults);
    this.product_name = JdbcWritableBridge.readString(5, __dbResults);
    this.product_price = JdbcWritableBridge.readFloat(6, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(product_category_id, 1 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(product_description, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeInteger(product_id, 3 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(product_image, 4 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(product_name, 5 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeFloat(product_price, 6 + __off, 7, __dbStmt);
    return 6;
  }
